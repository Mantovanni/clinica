...
export function ativar(seletor, data, callBackFunction) {
    ...
    const autoCompleteJS = new autoComplete({
        ...
        data: {
            ...
            // src: async () => {
            //     const response = await fetch("../controller/geral/ControllerGeral.class.php", {
            //         // cache: "force-cache",
            //         method: "POST",
            //         body: JSON.stringify({
            //             metodo: "listar",
            //             tabela: "produtos",
            //         })//body é o corpo da mensagem payload
            //     });
        ...
        resultsList: {
            noResults: (list, query) => {
                ...
                message.setAttribute("tabindex", "1");
                message.innerHTML = `
                 <span class="autocomplete-noresults";">
                 Nenhum resultado encontrado.
                 </span>`;
                //  Nenhum resultado"${query}"
                list.appendChild(message);
            },
            // navigation : event =>{
        ...
        onSelection: (feedback) => {         
            ...
            document.querySelector(seletor).value = selection;
