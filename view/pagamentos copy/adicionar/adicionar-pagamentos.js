...
export function init(valueInit) {
    ...
    //=====================================================================================================
    //=====================================================================================================
    // tituloPage.textContent = "Adicionar Pagamentos";
    ...
    function salvarForm(form) {
         ...
         if (validarForm(form)) {
             ...
             b.crud.salvar(b.form.extractValues(form), "pagamentos", responseItemSalvo => {//async
                 b.modal.fechar();
                ...
                //  responseItemSalvo.id = responseItemSalvo.id.padStart(2, '0');
                 ...
                 const linhaCriada = b.render.lineInTable(tbody, responseItemSalvo, "pagamentos");
