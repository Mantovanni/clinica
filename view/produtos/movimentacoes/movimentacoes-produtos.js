...
export default class Movimentacoes {
    ...
    constructor(idProdutoInit) {
        ...
        //GLOBAIS
        //----------------------------------------------------------
        this.adicionarUrl = "../view/estoques/movimentacoes/form/adicionar-movimentacoes.html";
        this.urlJs = "../../../view/estoques/movimentacoes/form/adicionar-movimentacoes.js";//Url partir do render.js
    ...
    carregarTabela(estoqueId) {
        ...
        b.crud.custom("listarMovimentacoesPorProdutoEstoque", "movimentacoes", data, responseList => {  //async        
            ...
            b.table.insertLineDesc(this.tbody, responseParaTabela, "movimentacoes",()=>{
                //after delete
                this.carregarDadosdoEstoque(b.selectValue(this.selectEstoques));
            });
