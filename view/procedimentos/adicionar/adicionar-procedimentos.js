...
export function init(valueInit) {
    ...
    function salvarForm(form) {
         ...
         if (validarForm(form)) {
             ...
             b.crud.salvar(b.form.extractValues(form), "procedimentos", responseItemSalvo => {//async
                 b.modal.fechar();
                ...
                //  responseItemSalvo.id = responseItemSalvo.id.padStart(2, '0');
                 ...
                 const linhaCriada = b.render.lineInTable(tbody, responseItemSalvo, "procedimentos");
